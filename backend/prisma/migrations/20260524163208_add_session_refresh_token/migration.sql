...
-- AlterEnum
BEGIN;
CREATE TYPE "TransactionType_new" AS ENUM ('INCOME', 'EXPENSE', 'TRANSFER_IN', 'TRANSFER_OUT', 'RECEIVABLE', 'PAYABLE');
...
-- DropIndex
DROP INDEX "Transaction_updatedAt_idx";

-- AlterTable
ALTER TABLE "Transaction" ADD COLUMN     "isReversed" BOOLEAN NOT NULL DEFAULT false,
